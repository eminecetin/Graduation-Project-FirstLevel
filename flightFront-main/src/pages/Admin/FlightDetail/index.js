...
import { fetchFlight, updateFlight} from '../../../api';
...
function FlightDetail(){
    ...
    const {isLoading, isError, data, error} = useQuery(
        ["admin:flight", flight_id],
         () => fetchFlight(flight_id)
    );
    ...
    const handleSubmit = async(values, bag) => {
        ...
        try{
            await updateFlight(values,  flight_id);
            message.success({
                content: "The flight successfully updated. ",
                key: "flight_update",
                duration:2
            });
        }catch(e){
            message.error("The flight dosn't updated. ");
        }
    };
